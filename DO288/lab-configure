...
# CHANGELOG
#   * Tue Aug 19 Jaime Ramirez <jaime.ramirez@redhat.com>
#   - Restored maven settings file for development mode
...
function lab_config {
  ...
  then
    fatal 2 "Cannot connect to an OpenShift 4.5 API using your URL." \
